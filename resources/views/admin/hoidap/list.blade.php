                ...
                <div class="col-xs-12">
                    <div class="box">
                        <div class="box-header">
                            <h3 class="box-title">Danh sách hỏi đáp</h3>
                            <div class="box-tools">
                                            ...
                                            <table class="table table-bordered table-hover">
                                                ...
                                                @foreach($object['list_hoidap'] as $hdap)
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-center">
                                                            <a class="btn btn-danger" title="Xóa dữ liệu" data-toggle="tooltip" data-placement="top" href="{{route('admin.hoidap.delete', ['id' => $hdap->id])}}"><i class="fa fa-remove"></i></a>&nbsp;
